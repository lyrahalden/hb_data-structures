...
def all_students_tuple_list(filename):
    ...
    for line in data:
        ...
        if line[4] == "G" or line[4] == "I":
            ...
            student = (line[0] + " " + line[1], line[2], line[3], line[4])
...
def find_cohort_by_student_name(student_list):
    ...
    input_student = raw_input("Enter a student name >>>  ")

    if input_student in student_list:
        return "%s was in the %s cohort." % (line[0], line[3])
    else:
